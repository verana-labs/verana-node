...
const (
	Query_Params_FullMethodName   = "/verana.dd.v1.Query/Params"
	Query_ListDIDs_FullMethodName = "/verana.dd.v1.Query/ListDIDs"
	Query_GetDID_FullMethodName   = "/verana.dd.v1.Query/GetDID"
)
...
func (c *queryClient) ListDIDs(ctx context.Context, in *QueryListDIDsRequest, opts ...grpc.CallOption) (*QueryListDIDsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ListDIDs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetDID(ctx context.Context, in *QueryGetDIDRequest, opts ...grpc.CallOption) (*QueryGetDIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetDID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
