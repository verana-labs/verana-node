...
const (
	Query_Params_FullMethodName              = "/verana.tr.v1.Query/Params"
	Query_GetTrustRegistry_FullMethodName    = "/verana.tr.v1.Query/GetTrustRegistry"
	Query_ListTrustRegistries_FullMethodName = "/verana.tr.v1.Query/ListTrustRegistries"
)
...
func (c *queryClient) GetTrustRegistry(ctx context.Context, in *QueryGetTrustRegistryRequest, opts ...grpc.CallOption) (*QueryGetTrustRegistryResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetTrustRegistry_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListTrustRegistries(ctx context.Context, in *QueryListTrustRegistriesRequest, opts ...grpc.CallOption) (*QueryListTrustRegistriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ListTrustRegistries_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
