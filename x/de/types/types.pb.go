...
type WindowEndQueueEntry struct {
	WindowEnd     time.Time `protobuf:"bytes,1,opt,name=window_end,json=windowEnd,proto3,stdtime" json:"window_end"`
	ParticipantId uint64    `protobuf:"varint,2,opt,name=participant_id,json=participantId,proto3" json:"participant_id,omitempty"`
}

func (m *WindowEndQueueEntry) Reset()         { *m = WindowEndQueueEntry{} }
func (m *WindowEndQueueEntry) String() string { return proto.CompactTextString(m) }
...
func (m *WindowEndQueueEntry) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *WindowEndQueueEntry) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_WindowEndQueueEntry.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *WindowEndQueueEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WindowEndQueueEntry.Merge(m, src)
}
func (m *WindowEndQueueEntry) XXX_Size() int {
	return m.Size()
}
func (m *WindowEndQueueEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_WindowEndQueueEntry.DiscardUnknown(m)
}

var xxx_messageInfo_WindowEndQueueEntry proto.InternalMessageInfo

func (m *WindowEndQueueEntry) GetWindowEnd() time.Time {
	if m != nil {
		return m.WindowEnd
	}
	return time.Time{}
...
func (m *WindowEndQueueEntry) GetParticipantId() uint64 {
	if m != nil {
		return m.ParticipantId
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*WindowEndQueueEntry)(nil), "verana.de.v1.WindowEndQueueEntry")
...
var fileDescriptor_ceceb116c414c04d = []byte{
	...
	,
}
...
func (m *WindowEndQueueEntry) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *WindowEndQueueEntry) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WindowEndQueueEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	n7, err7 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.WindowEnd, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.WindowEnd):])
	if err7 != nil {
		return 0, err7
	}
	i -= n7
...
func (m *WindowEndQueueEntry) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *WindowEndQueueEntry) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WindowEndQueueEntry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WindowEndQueueEntry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
